...
// FindRecentUsers retrieves users created within the last N days who have push notification tokens.
func (r *userRepository) FindRecentUsers(appName string, days int) ([]models.User, error) {
	var users []models.User
