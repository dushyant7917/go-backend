...
// RegisterFunctions creates and registers the notification sender function with the Inngest client.
func RegisterFunctions(client inngestgo.Client, pushClient *notification.ExpoPushClient) error {
