...
- `pause_underperforming_adsets` — pause Meta ad sets whose cost-per-result exceeds threshold bands; campaigns configured via `META_CAMPAIGN_IDS`; runs every 2 hours
